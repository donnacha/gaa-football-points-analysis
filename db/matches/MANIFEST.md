...
| 3 | hurling | senior | championship (AI+Lein+Mun) | 1990–2025 | 849 | knockout→back-door(1997)→qualifier→round-robin; Ulster SHC excluded |

Running total: **7609 matches** (football 1887–2025 champ + NFL 2008–2025; hurling SHC 1990–2025).
Wave 3 in progress — hurling SHC (Liam MacCarthy). Next: hurling SHC 1980–1989, then back toward
1887 (Munster/Leinster deciders + AI). Then wave 4 (hurling NHL), wave 5+ (Tailteann, U20/U21, minor).
